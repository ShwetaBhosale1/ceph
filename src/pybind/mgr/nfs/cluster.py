...
class NFSCluster:
    ...
    def validate_qos_type(self,
        ...
        if bw_obj:
            ...
            is_other_enable = qos_obj.ops_obj.enable_ops_ctrl if qos_obj.ops_obj else False
            ...
            is_this_enable = qos_obj.ops_obj.enable_ops_ctrl if qos_obj.ops_obj else False
            ctrl_type = "Bandwidth"
